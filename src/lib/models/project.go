...
// Uses the same nested structure as CreateProjectRequest for consistency and simplicity
type UpdateProjectRequest CreateProjectRequest

// LegacyUpdateProjectRequest represents the old flat structure for backward compatibility
type LegacyUpdateProjectRequest struct {
