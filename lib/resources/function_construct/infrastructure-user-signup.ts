...
export class InfrastructureUserSignup extends Construct {
    ...
    constructor(scope: Construct, id: string, props: FuncProps) {
        ...
        const functionName = `${props?.options.githubRepo}-user-signup`

        // Get centralized VPC configuration
        const vpcConfig = getDatabaseVpcConfig(this, 'UserSignup');
        ...
        this.func = new GoFunction(this, id, {
            entry: path.join(__dirname, `../../../src/infrastructure-user-signup`),
