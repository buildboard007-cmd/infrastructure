...
export class InfrastructureRolesManagementFunction extends Construct {
    ...
    constructor(scope: Construct, id: string, props: FuncProps) {
        ...
        const functionName = `${props?.options.githubRepo}-roles-management`

        this.func = new GoFunction(this, id, {
            entry: path.join(__dirname, `../../../src/infrastructure-roles-management`),
