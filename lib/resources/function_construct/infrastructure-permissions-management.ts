...
export class InfrastructurePermissionsManagementFunction extends Construct {
    ...
    constructor(scope: Construct, id: string, props: FuncProps) {
        ...
        const functionName = `${props?.options.githubRepo}-permissions-management`

        this.func = new GoFunction(this, id, {
            entry: path.join(__dirname, `../../../src/infrastructure-permissions-management`),
            functionName: functionName,
            timeout: Duration.seconds(30), // Longer timeout for database operations
