...
export class InfrastructureLocationManagement extends Construct {
    ...
    constructor(scope: Construct, id: string, props: FuncProps) {
        ...
        const functionName = `${props?.options.githubRepo}-location-management`

        this.func = new GoFunction(this, id, {
            entry: path.join(__dirname, `../../../src/infrastructure-location-management`),
